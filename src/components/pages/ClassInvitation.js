...
export default function ClassInvitation({hash}) {
    ...
    const handleAcceptInvitation = async () => {
        ...
        try {
            const response = await axios.post(`api/v1/classes/${classId}/classMemberships`, data);
            ...
            >
                ...
                >
                    ...
                    <Box component="form" noValidate sx={{mt: 1}} width="100%">
                        {user && inviter && classDetails && <Typography component="body1">
                            Dear <b>{user.firstName + ' ' + user.lastName}</b>,
                            <br/>
                            You have been invited by <b>{inviter.firstName + ' ' + inviter.lastName} </b> to
                            join <b>{classDetails.className}{classDetails.description && ' - ' + classDetails.description}</b> as
                            a <b>{role}</b>.
                            <br/>
